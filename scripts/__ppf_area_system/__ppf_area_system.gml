...
// Shader uniforms
/// @ignore
global.__ppf_area_shader_uniforms = {
	mask_render_posres : shader_get_uniform(__ppf_sh_sprite_mask, "u_render_pos_res"),
	mask_render_tex : shader_get_sampler_index(__ppf_sh_sprite_mask, "u_render_tex"),
}
...
function area_draw_sprite_mask(sprite_mask, subimg, x, y, pp_index) {
	...
	if surface_exists(_surf) {
		shader_set(__ppf_sh_sprite_mask);
		shader_set_uniform_f(global.__ppf_area_shader_uniforms.mask_render_posres, pp_index.__render_x, pp_index.__render_y, pp_index.__render_surface_width, pp_index.__render_surface_height);
		texture_set_stage(global.__ppf_area_shader_uniforms.mask_render_tex, surface_get_texture(_surf));
